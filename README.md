...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:hola@markelramiro.com)
...
Software Engineer with a B.Sc. in Artificial Intelligence from the University of the Basque Country. I specialize in building scalable ML systems, data pipelines, and cloud infrastructure. Previously worked as a Data & AI Engineer at Devol RPA and founded Wippass, a ticketing platform that processed over 25,000 EUR in transactions.
...
| Project | Description |
|---------|-------------|
| **[Anomaly Detection System](https://markelramiro.com)** | API performance monitoring using statistical ML methods on Kubernetes |
| **[DocMind](https://markelramiro.com)** | LLM-based document extraction and processing system |
| **[Financial Prediction Model](https://markelramiro.com)** | S&P 500 outperformance diagnosis using SHAP explainability |
| **[Wippass](https://markelramiro.com)** | Full-stack ticketing platform — 25,000+ EUR processed |
| **[LinkedIn Job Finder](https://github.com/Riemann-def/linkedin-job-finder)** | Bot for searching and analyzing LinkedIn jobs with AI filtering |
...
| Role | Company | Period |
|------|---------|--------|
| Software Engineer | **Multiverse Computing** | Oct 2025 -- Present |
| Data & AI Engineer | **Devol RPA** | Jul 2024 -- Oct 2025 |
| Computer Vision Engineer | **Nomada Omnimotion** | VR pose estimation & sensor fusion |
| Founder | **Wippass** | Full-stack ticketing platform |
...
<div align="center">
  <img src="https://visitor-badge.laobi.icu/badge?page_id=Riemann-def.Riemann-def&left_color=grey&right_color=blue" />
</div>
